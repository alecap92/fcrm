...
const dummyCampaigns: Campaign[] = [
  {
    ...
    subject: 'Novedades y actualizaciones importantes',
    template: {
  ...
  },
  {
    ...
    subject: 'No te pierdas nuestro próximo webinar',
    template: {
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Gestiona tus campañas de correo electrónico
              </p>
            </div>
            <Button onClick={() => navigate('/mass-email/new')}>
                  ...
                  <tr key={campaign.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex flex-col gap-1">
                        ...
                        {campaign.progress && (
                          <div className="text-xs text-gray-500">
                            <div>{campaign.progress.sent} de {campaign.progress.total} enviados</div>
                            <div>{campaign.progress.opens} aperturas</div>
                            <div>{campaign.progress.clicks} clicks</div>
                          </div>
                        )}
                      </div>
                    </td>
