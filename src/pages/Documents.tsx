            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-100">
                  ...
                  <th className="text-left py-4 px-6 text-sm font-medium text-gray-600">Uploaded By</th>
                ...
                {documents?.length === 0 ? (
                  <tr>
                    <td colSpan={7} className="py-8 text-center text-gray-500">
                      No hay documentos disponibles. Sube un documento para comenzar.
                    </td>
                  </tr>
                ) : (
                  documents?.map((doc) => (
                    <tr key={doc._id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="py-4 px-6">
                        <span className="text-sm text-gray-600">{(doc.size/1000000).toFixed(2)} MB</span>
                      </td>
                      <td className="py-4 px-6">
                        <span className="text-sm text-gray-600">{doc.uploadedBy.email}</span>
                      </td>
                      <td className="py-4 px-6">
                        <span className="text-sm text-gray-600">{ new Date(doc.uploadDate).toLocaleDateString( 'es-CO', { year: 'numeric', month: 'long', day: 'numeric' })}</span>
                      </td> 
                      <td className="py-4 px-6">
          ...
          <div className="p-6 border-t border-gray-100">
            <div className="flex items-center justify-between">
              <p className="text-sm text-gray-600">
                Showing <span className="font-medium">1</span> to <span className="font-medium">{documents?.length || 0}</span> of{' '}
                <span className="font-medium">{documents?.length || 0}</span> documents
              </p>
