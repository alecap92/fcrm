...
import {normalizeContact} from "../../lib/parseContacts.ts"
...
export function ContactSelectionModal({ isOpen, onClose, onSelect }: ContactSelectionModalProps) {
...
setContacts(response.map(normalizeContact));
