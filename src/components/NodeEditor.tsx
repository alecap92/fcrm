...
const availableVariables: Variable[] = [
  { name: "{{deal._id}}", description: "Deal ID", example: "507f1f77bcf86cd799439011" },
  { name: "{{deal.name}}", description: "Deal Name", example: "Big Sale Q1" },
  { name: "{{contact.email}}", description: "Contact Email", example: "john@example.com" },
  { name: "{{contact.name}}", description: "Contact Name", example: "John Doe" },
  { name: "{{status}}", description: "Current Status", example: "approved" },
  { name: "{{organization.name}}", description: "Organization Name", example: "Acme Inc" },
];

const VariableSelector = ({ onSelect }: { onSelect: (variable: string) => void }) => {
              ...
              {availableVariables.map((variable) => (
                ...
                >
                  <div className="flex justify-between">
                    <span className="text-sm font-mono text-blue-600">{variable.name}</span>
                    <span className="text-xs text-gray-500">e.g. {variable.example}</span>
                  </div>
...
export const NodeEditor: React.FC<NodeEditorProps> = ({ nodeId, type, data, onClose }) => {
  ...
  const insertVariable = (fieldName: string, variable: string) => {
    const textarea = document.querySelector(`[name="${fieldName}"]`) as HTMLTextAreaElement;
    if (textarea) {
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between items-center">
                ...
                <VariableSelector onSelect={(v) => insertVariable('recipient', v)} />
              </div>
              <input
                type="text"
                name="recipient"
            ...
            <div>
              <div className="flex justify-between items-center">
                ...
                <VariableSelector onSelect={(v) => insertVariable('subject', v)} />
              </div>
              <input
                type="text"
                name="subject"
            ...
            <div>
              <div className="flex justify-between items-center">
                ...
                <VariableSelector onSelect={(v) => insertVariable('content', v)} />
              </div>
              <textarea
                name="content"
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center">
                ...
                <VariableSelector onSelect={(v) => insertVariable('message', v)} />
              </div>
              <textarea
                name="message"
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center">
                ...
                <VariableSelector onSelect={(v) => insertVariable('headers', v)} />
              </div>
              <textarea
                name="headers"
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between items-center">
                ...
                <VariableSelector onSelect={(v) => insertVariable('condition', v)} />
              </div>
              <textarea
                name="condition"
                    ...
                    {['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map((day) => (
                      <label key={day} className="inline-flex items-center">
                        <input
                          ...
                          defaultChecked={data.workingDays?.[day.toLowerCase()] ?? ['Mon', 'Tue', 'Wed', 'Thu', 'Fri'].includes(day)}
