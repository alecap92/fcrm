    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-[60]">
      <div className="bg-white rounded-xl w-full max-w-md shadow-2xl" onClick={(e) => e.stopPropagation()}>
        <div className="flex justify-between items-center px-6 py-4 border-b">
          <h2 className="text-xl font-semibold text-gray-800">Seleccionar producto</h2>
          <button 
            onClick={onClose} 
        ...
        <div className="p-6">
          <div className='flex gap-2'>
            ...
            <input 
                ...
                onChange={(e) => setForm({...form, priceAtAcquisition: e.target.value})}
                type="number" 
            ...
            <button
                ...
                disabled={!form.productId || !form.quantity || !form.priceAtAcquisition || (selectedProduct?.hasVariants && !form.variantId)}
